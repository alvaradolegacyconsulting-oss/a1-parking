...
--     dropped by         : 20260714_anon_rpc_ilike_wildcard_close.sql
--     current definition : 20260714_anon_rpc_ilike_wildcard_close.sql
...
--     dropped by         : 20260728_property_name_aliases_schema.sql
--     current definition : 20260728_property_name_aliases_schema.sql
--     consequence        : ⚠ this file DROPs and recreates the function,
--                          so re-applying silently REVERTS its body to
--                          this older definition. No error, no ambiguity —
--                          just the wrong code running.
