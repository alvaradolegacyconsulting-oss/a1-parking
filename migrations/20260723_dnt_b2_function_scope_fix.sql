...
--
--   check_dnt_plate()
--     dropped by         : 20260723_do_not_tow_cascade_and_guards.sql
--     current definition : 20260723_do_not_tow_cascade_and_guards.sql
...
--
--   pm_plate_lookup()
--     dropped by         : 20260724_pm_plate_lookup_viewing_property.sql
--     current definition : 20260805_pm_plate_lookup_current_date_central_sweep.sql
--     consequence        : ⚠ this file DROPs and recreates the function,
--                          so re-applying silently REVERTS its body to
--                          this older definition. No error, no ambiguity —
--                          just the wrong code running.
--
