...
--     dropped by         : 20260713_tos_acceptances_company_id_derivation.sql
...
--     dropped by         : 20260710_acceptance_reviewed_at_redeem_extension.sql
--     current definition : 20260710_acceptance_reviewed_at_redeem_extension.sql
--     consequence        : 🔴 this file does not itself DROP the function,
--                          so re-applying RESURRECTS the old signature
--                          alongside the current one. PostgREST then
--                          returns PGRST203 'could not choose the best
