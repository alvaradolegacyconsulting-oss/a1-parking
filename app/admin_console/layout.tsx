// ════════════════════════════════════════════════════════════════════
// /admin_console/layout.tsx — server-side consent-gate for the Admin
// Console (separate route root from /admin, same admin role)
// P1 CONSENT HARD-GATE Commit 3b · 2026-07-16
//
// Propagated verbatim from /company_admin/layout.tsx (613b045).
// hasCurrentConsents returns 2 docs for admin (tos + privacy). Loop
