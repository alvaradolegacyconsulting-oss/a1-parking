...
//
// Extracted from app/terms/page.tsx (behavior-neutral refactor) so the
// same body renders both at /terms and inside the <LegalReadthroughGate>
// scroll pane (via the acceptance-surface flow). One source of truth.
