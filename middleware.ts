...
export async function middleware(request: NextRequest) {
  ...
  // being added below.
  const publicPaths = ['/login', '/visitor', '/visitor-select', '/register', '/change-password', '/terms', '/privacy', '/signup', '/account-cancelled', '/deactivated', '/ticket/view', '/api/help-feedback', '/api/stripe/webhook', '/api/cron', '/api/signup', '/api/register/create-user', '/api/register/companion-vehicle', '/api/register/captcha-verify', '/api/visitor/create-pass', '/api/visitor/refusal-log', '/forgot-password', '/reset-password', '/auth/accept']
