...
export async function middleware(request: NextRequest) {
  ...
  // being added below.
  const publicPaths = ['/login', '/visitor', '/visitor-select', '/register', '/change-password', '/terms', '/privacy', '/signup', '/account-cancelled', '/help', '/ticket/view', '/api/help-feedback', '/api/stripe/webhook', '/api/cron', '/api/signup', '/forgot-password', '/reset-password']
